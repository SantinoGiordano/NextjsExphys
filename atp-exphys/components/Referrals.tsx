...
export function Referrals() {
  ...
  return (
    <div id="Referrals" className="py-16 bg-gray-100 text-center">
      <h1 className="text-5xl font-bold mb-6 text-gray-800">Our Trusted Referrals</h1>
      <hr className="w-1/4 mx-auto mb-12 border-gray-400" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 px-8">
        {referrals.map((referral) => (
          ...
          >
            ...
            <div className="mt-4">
              <p className="text-2xl font-semibold text-gray-800">{referral.name}</p>
            </div>
          </div>
        ))}
      </div>
